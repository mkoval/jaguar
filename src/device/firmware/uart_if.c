...
//*****************************************************************************
//
// A flag that is non-zero if an enumeration response needs to be sent.
//
//*****************************************************************************
static unsigned long g_ulUARTEnum = 0;
...
UARTIFCommandHandler(void)
{
        ...
        (g_sParameters.ucDeviceNumber != 0)))
    {
        ...
        {
            UARTIFSendMessage(*(unsigned long *)g_pucResponse,
